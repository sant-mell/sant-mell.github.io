    ...
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 flex flex-col items-center w-full justify-center gap-8 p-4 relative overflow-hidden">
      ...
      {cvUrl && (
        <Button
          asChild
          size="lg"
          className="relative z-10 rounded-full px-8 shadow-lg shadow-blue-500/20 transition-transform hover:scale-105 active:scale-95"
        >
    ...
    <div className="group relative overflow-hidden rounded-3xl bg-white dark:bg-gray-800 p-6 w-80 shadow-[12px_12px_24px_rgba(0,0,0,0.15),-12px_-12px_24px_rgba(255,255,255,0.9)] dark:shadow-[12px_12px_24px_rgba(0,0,0,0.3),-12px_-12px_24px_rgba(255,255,255,0.1)] transition-all duration-500 hover:shadow-[20px_20px_40px_rgba(0,0,0,0.2),-20px_-20px_40px_rgba(255,255,255,1)] dark:hover:shadow-[20px_20px_40px_rgba(0,0,0,0.4),-20px_-20px_40px_rgba(255,255,255,0.15)] hover:scale-105 hover:-translate-y-2">
          ...
          {tags.map((tag) => (
            <span
              ...
              className={cn(
                ...
                tag === "Open to Work" &&
                  "text-blue-600 dark:text-blue-400 group-hover:bg-blue-50 dark:group-hover:bg-blue-900/30 group-hover:shadow-[0_0_10px_rgba(59,130,246,0.3)]",
              )}
            >
              {tag}
            </span>
      ...
      <div className="mt-6 flex gap-2 relative z-10">
        <a
          ...
          className="flex-1 rounded-full bg-white dark:bg-gray-700 py-4 text-sm font-medium text-blue-600 dark:text-blue-400 shadow-[6px_6px_12px_rgba(0,0,0,0.1),-6px_-6px_12px_rgba(255,255,255,0.9)] dark:shadow-[6px_6px_12px_rgba(0,0,0,0.2),-6px_-6px_12px_rgba(255,255,255,0.1)] transition-all duration-300 hover:shadow-[2px_2px_4px_rgba(0,0,0,0.05),-2px_-2px_4px_rgba(255,255,255,0.8)] dark:hover:shadow-[2px_2px_4px_rgba(0,0,0,0.15),-2px_-2px_4px_rgba(255,255,255,0.05)] hover:scale-95 active:scale-90 group-hover:bg-blue-50 dark:group-hover:bg-blue-900/30"
        >
